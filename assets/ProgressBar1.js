...
const SVG = ({
  ...
  >
                    ...
                    <circle id="Oval" stroke="#00848E" strokeWidth="3" cx="22.5" cy="22.5" r="21" fill="#ffffff"></circle>
                    ...
                    <text id="1" fontFamily="Roboto-Bold, Roboto" fontSize="20" fontWeight="bold" fill="#00848E">
