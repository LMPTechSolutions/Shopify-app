...
const SVG = ({
  ...
  >
                                        <circle id="Oval" stroke="#00848E" strokeWidth="3" cx="203.5" cy="22.5" r="21" fill="#ffffff"></circle>
                    ...
                    <circle id="Oval" stroke="#00848E" strokeWidth="3" cx="384.5" cy="22.5" r="21"></circle>
                    <circle id="Oval" stroke="#00848E" strokeWidth="3" fill="#00848E" cx="384.5" cy="22.5" r="22.5"></circle>
                    ...
                    <text id="2" fontFamily="Roboto-Bold, Roboto" fontSize="20" fontWeight="bold" fill="#00848E">
