...
const SVG = ({
  ...
  >
        ...
        <g id="onboarding:-step-5-[desktop]" transform="translate(-390.000000, -248.000000)">
            <g id="admin-panel/progress-bar-5-admin-panel/desktop/progress-bar-5" transform="translate(392.000000, 250.000000)">
                <g id="progress-bar-5">
                    ...
                    <circle id="Oval" fill="#00848E" cx="384.5" cy="22.5" r="22.5"></circle>
                    <path d="M407,23.1394043 L543,22.5" id="Line-2" stroke="#00848E" strokeWidth="5" strokeLinecap="square"></path>
                    <circle id="Oval" stroke="#00848E" strokeWidth="3" cx="748.5" cy="22.5" r="21"></circle>
                    <path d="M588,23.1394043 L726,23.1394043" id="Line-2" stroke="#00848E" strokeWidth="5" strokeLinecap="square"></path>
                    <text id="5" fontFamily="Roboto-Bold, Roboto" fontSize="20" fontWeight="bold" fill="#00848E">
